...
Trip.create!({
  ...
  time: Time.new(2018,12,10,12,30),
...
Trip.create!({
  ...
  time: Time.new(2018,12,10,12,40),
  # date: Date.new(2018,12,14),
  user_id: 2,
  airport_id: Airport.where(iata_code:"DPS").ids.join.to_i,
  ride_mates_limit: 3
...
Trip.create!({
  ...
  time: Time.new(2018,12,10,12,50),
  # date: Date.new(2018,12,14),
  user_id: 3,
  airport_id: Airport.where(iata_code:"DPS").ids.join.to_i,
  ride_mates_limit: 3
...
Trip.create!({
  ...
  time: Time.new(2018,12,10,13,50),
  # date: Date.new(2018,12,14),
  user_id: 8,
  airport_id: Airport.where(iata_code:"MLB").ids.join.to_i,
  ride_mates_limit: 3
...
Trip.create!({
  ...
  time: Time.new(2018,12,10,13,10),
  # date: Date.new(2018,12,14),
  user_id: 9,
  airport_id: Airport.where(iata_code:"MLB").ids.join.to_i,
  ride_mates_limit: 3
...
Trip.create!({
  ...
  time: Time.new(2018,12,10,13,30),
  # date: Date.new(2018,12,14),
  user_id: 15,
  airport_id: Airport.where(iata_code:"PTY").ids.join.to_i,
  ride_mates_limit: 3
